...
description: |
  La participation aux activités du Groupe d'Archéologie Computationnelle implique l'acceptation et le respect de notre code de conduite.
output:
...
Les cas de comportements abusifs, harcelants ou tout autre comportement inacceptables peuvent être signalés aux dirigeant·e·s de la communauté responsables de l'application du code de conduite. Toutes les plaintes seront examinées et feront l'objet d'une enquête rapide et équitable.
